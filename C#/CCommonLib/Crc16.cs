...
namespace CCommonLib
{
    public static class Crc16
    {
        ...
        public static void ConCRC(ref byte[] bufin, byte n, ushort init = 0xffff)
        {
            ushort crc16 = init;
            byte i;
            //n个数据的CRC校验
        ...
        /// <param name="bufin">信息串</param>
        /// <param name="n">不包括校验字的串总长度</param>
        public static ushort GetCRC(in byte[] bufin, byte n, ushort init = 0xffff)
        {
            ushort crc16 = init;
            byte i;
            //n个数据的CRC校验
        ...
        public static bool DataCRC(ref byte[] bufout, byte count, ushort init = 0xffff)
        {
            ushort crc16 = init;
            byte i;
            for (i = 0; i < (count - 2); i++)
